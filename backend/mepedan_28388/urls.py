"""mepedan_28388 URL Configuration
...
admin.site.site_header = "Mepedan"
admin.site.site_title = "Mepedan Admin Portal"
admin.site.index_title = "Mepedan Admin"

# swagger
api_info = openapi.Info(
    title="Mepedan API",
    default_version="v1",
    description="API documentation for Mepedan App",
)
